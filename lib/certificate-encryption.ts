...
export const AES_ENCRYPTION_KEY = 'CSG@2025_SECURE_CERTIFICATE_KEY_2025';

// Initialization Vector (16 bytes for AES)
export const AES_IV = 'CSG_SECURE_IV_25';
 ...
 */
export function encryptWithAES(data: any): string {
  try {
